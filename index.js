...
for (let rowIndex = 0; rowIndex < rows; rowsIndex++) {
    ...
    for (let columnIndex = 0; columnIndex < columns; columnIndex++) {
        ...
        tileColumn.setAttribute("row" + rowIndex + "columns" + columnIndex); // Dar id da coluna separada da fileira.
        tileColumn.setAttribute("tile-column"); // Dar classe para coluna.
